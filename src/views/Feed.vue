        ...
        <div class="col-lg-4 col-md-12">
          ...
          <div class="card-media-body">
            <div class="card-media-body-top">
              <span><img style="width: 40px; height: 40px; border-radius: 50%; margin-right: 5px;" src="../assets/img/filler.jpg" class="img-responsive"></span>
              <span class="subtle">6 Days Ago</span>
            ...
            <div class="card-media-body-supporting-bottom card-media-body-supporting-bottom-reveal">
              <a href="#/" class="card-media-body-supporting-bottom-text card-media-link u-float-right">LEARN MORE</a>
            </div>
          </div>
        </div>
        </div> 
